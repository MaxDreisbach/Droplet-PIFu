...
class TrainDataset_vis(Dataset):
    @staticmethod
    ...
    def __init__(self, opt, phase='train'):
        ...
        #change Render path back to default after training on monocromatic dataset
        if opt.RGB:
            self.RENDER = os.path.join(self.root, 'RENDER')
        else:
            self.RENDER = os.path.join('./train_data_DFS2023E/RENDER')
        ...
        # modified GEO to only load required meshes online
        # implemented in select_sampling_method() lines 265ff.
    ...
    def get_render(self, subject, num_views, yid=0, pid=0, random_sample=False):
        ...
        return {
            ...
            'raw_img': torch.stack(raw_list, dim=0),
    ...
    def select_sampling_method(self, subject):
        ...
        # online loading of meshes during runtime instead of before
