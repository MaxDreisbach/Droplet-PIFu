...
def computePRT(mesh_path, n, order):
    ...
    # NOTE: trimesh sometimes breaks the original vertex order, but the topology will not change.
    # when loading PRT in other programs, use the triangle list from trimesh.
